        ...
        <div className="row align-items-center g-5">
          <div className="col-lg-6">
            ...
            <p style={{ fontSize: "18px", color: "#50604b", lineHeight: "1.8" }}>
              Our official flight booking service is being prepared. Until our government approval is complete,
            ...
            <div style={{
              ...
              <p style={{ marginBottom: 0, color: "#667" }}>
                We will keep your request in our priority list and notify you once flight booking support starts.
              </p>
            </div>
          </div>
          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <textarea
                ...
                name="message"
                rows="4"
                placeholder="Tell us your flight plan..."
